        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-2/3 px-4 mb-8 md:mb-0 order-last md:order-first">
            <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
              ...
              <h2 className="text-2xl font-bold mb-4 dark:text-white">Main Article</h2>
          ...
          <div className="w-full md:w-1/3 px-4 order-first md:order-last">
            <div className="sticky top-16">
              <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4">
                ...
                <h2 className="text-2xl font-bold mb-4 dark:text-white">Sidebar</h2>
                <p className="text-white">Some sidebar content goes here.</p>
